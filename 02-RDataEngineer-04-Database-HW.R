...
# 你的答案應該是一個字串
twii_head <- {
    dbReadTable(db, "TWII")[1,1]# 請填寫你的程式碼
}
twii_tail <- {
    tail(dbReadTable(db, "TWII")[,1],1)# 請填寫你的程式碼
}
...
{
    setosa <- dbWriteTable(db, "setosa", 
                           iris[iris$Species == "setosa",], 
                           overwrite = TRUE)# 請填寫你的程式碼
}

# 請確實將資料寫入！
{
    dbCommit(db)# 請填寫你的程式碼
}
